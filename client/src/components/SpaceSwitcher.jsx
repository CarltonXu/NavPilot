...
export default function SpaceSwitcher({ space, onChange, userName, canEditPublic=false, publicEditMode=false, isPersonalOwner=false, personalEditMode=false, onEnterPublicEdit, onExitPublicEdit, onEnterPersonalEdit, onExitPersonalEdit, locked=false, lockLabel='', actions=null }) {
  const { t } = useI18n();
