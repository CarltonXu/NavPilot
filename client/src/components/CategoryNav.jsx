...
export default function CategoryNav({ categories, counts, active, onSelect, manageable=false, onCreate, onRename, onDelete, onDropItems, selectionStates, onToggleSelection, selectionDisabled=false }) {
  const { t } = useI18n();
